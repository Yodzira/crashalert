	...
	public static function render_timeline() {
		...
		<div class="wrap">
			...
			<p class="description">
				...
				<a href="https://yodsira.com/buy/crashalert" target="_blank" rel="noopener"><?php esc_html_e( 'Upgrade to CrashAlert Pro', 'crashalert' ); ?> &rarr;</a>
			</p>
	...
	public static function render_settings() {
		...
		<div class="wrap">
			...
			<div class="notice notice-info"><p>
				...
				<a href="https://yodsira.com/buy/crashalert" target="_blank" rel="noopener">CrashAlert Pro &rarr;</a>
			</p></div>
